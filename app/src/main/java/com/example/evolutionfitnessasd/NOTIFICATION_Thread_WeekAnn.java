...
public class NOTIFICATION_Thread_WeekAnn extends Application implements Runnable{
        ...
        public NOTIFICATION_Thread_WeekAnn (NotificationChannel chan, NotificationManager man, NotificationCompat.Builder build,PendingIntent pending) {
        ...
        public boolean weekAnn(){
            if(annC!=null){
                annC.add(annC.DAY_OF_MONTH,-7);
            }
            currentAnn = sdf.format(annC.getTime());
            System.out.println("WEEK ANN: "+currentAnn);
