...
public class NOTIFICATION_Thread_DayAbb extends Application implements Runnable{
        ...
        public NOTIFICATION_Thread_DayAbb (NotificationChannel chan, NotificationManager man, NotificationCompat.Builder build,PendingIntent pending) {
